  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell: 'text-muted-foreground rounded-md w-11 font-light text-[0.8rem]',
        ...
        day: cn(
          ...
          'h-11 w-11 p-0 font-light aria-selected:opacity-100'
        ),
        day_range_end: 'day-range-end',
        day_selected:
          'bg-taiga text-primary-foreground hover:bg-taiga-light hover:text-primary-foreground focus:bg-taiga focus:text-primary-foreground',
