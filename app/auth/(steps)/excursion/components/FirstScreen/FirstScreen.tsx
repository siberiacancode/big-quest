...
export const FirstScreen = ({ onNextClick, onSkipClick }: FirstScreenProps) => (
    ...
    <div className='flex flex-grow flex-col px-4'>
      <div className='mt-[40px] flex-grow px-[42px]'>
        <Typography variant='h4' className='text-center'>
          <I18nText path='auth.excursion.first.title' />
        </Typography>
        <Typography variant='sub3' className='mt-4 text-center text-muted-foreground'>
          <I18nText path='auth.excursion.first.description' />
        </Typography>
      </div>
