    ...
    <div className='flex flex-wrap gap-2'>
      <div className='relative  mt-2.5 flex  h-64 w-full flex-col items-center'>
        <Image
          ...
          alt='org-background'
        />
        <div className='absolute bottom-0  mx-4  mt-auto  h-36 w-[96%] rounded-lg border bg-white/70 pb-4 pl-4 pr-4 pt-3  text-card-foreground shadow-sm backdrop-blur-lg'>
          <div className='flex'>
            <Image
              priority={false}
              className='h-20 w-20 rounded border-2 border-solid '
              src={organizationBackground}
              alt='org-background'
            />
          ...
          <div>
            <TabsList className='items-top flex w-full justify-end gap-1 bg-transparent'>
              {data.type === 'PARTNER' ? (
