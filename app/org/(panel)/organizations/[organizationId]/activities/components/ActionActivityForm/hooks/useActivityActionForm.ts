...
export const useActivityActionForm = ({
  ...
  return {
    state: {
      ...
      isPending: getCategoryQuery.isPending || getActivityByIdQuery.isPending,
      isLoading: getCategoryQuery.isPending || getActivityByIdQuery.isPending,
      isCategoryOpen,
      isStatusOpen,
      isPostActivityLoading: false,
