...
export const SponsorsSection = () => (
  ...
  >
    <div className='container relative w-max mdx:max-w-full'>
      <div className='z-3 absolute -left-8 top-10 h-full w-full rounded-[30px] border-2 border-dashed border-taiga-light xlx:-left-1 xlx:w-[94%] 2mdx:w-[93%] mdx:left-3 mdx:top-6 mdx:w-[88%]' />
      <div className='relative z-10 flex w-fit flex-col rounded-[30px] bg-white px-[111px] py-[72px] 2mdx:px-[80px] mdx:mx-2 2smx:px-[24px]'>
