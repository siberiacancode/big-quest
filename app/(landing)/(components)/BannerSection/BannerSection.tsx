...
export const BannerSection = () => (
  <section className='container flex  min-h-[600px] items-center justify-center overflow-x-hidden px-20 mdx:px-11 xsx:px-5'>
    <div className='flex w-full items-center justify-between xlx:justify-center'>
      ...
      <div className='relative xlx:hidden'>
        <Image
          src={bannerImage}
          alt='info image'
          className='w-[46rem] xlx:block xlx:w-96 mdx:hidden'
        />
      </div>
    </div>
  </section>
